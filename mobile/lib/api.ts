...
import { getCalibrationExamples, pickRepresentativeExamples } from './calibration';
...
const LANDMARK_META: Record<string, { label: string; instruction: string }> = {
  ...
  left_brow:          { label: 'Right Eyebrow',       instruction: 'Place at the highest arch of your right eyebrow.' },
  right_brow:         { label: 'Left Eyebrow',        instruction: 'Place at the highest arch of your left eyebrow.' },
  left_pupil:         { label: 'Right Eye',           instruction: 'Place at the center of your right eye, directly on the pupil.' },
  right_pupil:        { label: 'Left Eye',            instruction: 'Place at the center of your left eye, directly on the pupil.' },
  ...
  left_nostril:       { label: 'Right Nostril',       instruction: 'Place at the outer base of your right nostril.' },
  right_nostril:      { label: 'Left Nostril',        instruction: 'Place at the outer base of your left nostril.' },
  left_mouth_corner:  { label: 'Right Mouth Corner',  instruction: 'Place at the right corner where your lips meet.' },
  right_mouth_corner: { label: 'Left Mouth Corner',   instruction: 'Place at the left corner where your lips meet.' },
  ...
  left_jaw:           { label: 'Right Jaw Angle',     instruction: 'Place where your jaw angles upward toward your right ear.' },
  right_jaw:          { label: 'Left Jaw Angle',      instruction: 'Place where your jaw angles upward toward your left ear.' },
  left_cheek:         { label: 'Right Cheekbone',     instruction: 'Place at the widest, most prominent point of your right cheekbone.' },
  right_cheek:        { label: 'Left Cheekbone',      instruction: 'Place at the widest, most prominent point of your left cheekbone.' },
};
